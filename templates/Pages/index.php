<header>
    <div class="header__title_content">
        ...
        <p>
            القرآن الكريم | راديو القرآن | اذاعة القرآن الكريم FM لايف الاستماع المباشر إلى إذاعة القرآن الكريم في تونس
            بث مباشر
        </p>
    </div>
</header>
                        ...
                        <div class="col-md-6">
                            <div class="card custom__radio__card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="article-date"><span>تم الإنشاء في : <?= $post->created->i18nFormat('dd MMMM, yyyy') ?> بواسطة : <?= $post->user->email ?></span></div>
                                    <a href="<?= $this->Url->build(['controller' => 'Posts', 'action' => 'detail', 'slug' => $post->slug, 'id' => $post->id]) ?>"
                                       class="btn btn-primary custom__radio__btn">مشاهدة المزيد </a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
            ...
            <div class="list__program">
                <div class="list__article__radio">
                    ...
                    <?php foreach ($programs as $program): ?>
                        <a href="<?= $this->Url->build(['controller' => 'Programs', 'action' => 'show', 'slug' => $program->slug, 'id' => $program->id]) ?>"
                           class="link__wrapper">
