    ...
    define('elFinderConfig', {
        ...
        defaultOpts: {
           ...
           /* getFileCallback: function (file, fm) {
            ...
            //Si en veux trix editor
            getFileCallback: function (file, fm) {
                const url = fm.convAbsUrl(file.url);

                if (window.opener && typeof window.opener.insertFile === 'function') {
                    window.opener.insertFile(url);
                } else {
                    alert('Trix editor not found');
                }
