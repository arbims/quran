...
class Application extends BaseApplication implements AuthenticationServiceProviderInterface
{
    ...
    public function services(ContainerInterface $container): void
    {
        ...
        $container->add(PostsTable::class, function () {
            return TableRegistry::getTableLocator()->get('Posts');
        });
        $container->add(ProgramsTable::class, function () {
            return TableRegistry::getTableLocator()->get('Programs');
        });
        $container->add(EpisodesTable::class, function () {
            return TableRegistry::getTableLocator()->get('Episodes');
        });
    }
